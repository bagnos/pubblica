<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IscrizioneNewsletter.aspx.cs" Inherits="pa_taverne.IscrizioneNewsletter" %>
            ...
            <tr>
                ...
                <td class="TdMainCorpo" align="center" valign="top">
                 <table cellpadding="3" class="TabellaGenerica" cellspacing="0" width="100%" >
                    <tr class="TrHeader">
                        <td align="center" class="TestoP"><b>DIVENTA NOSTRO AMICO</b></td>
                    </tr>
                    <tr>
                        ...
                        <table width="100%" border="0" cellpadding="4" cellspacing="4">
                            <tr>
                                <td align="justify" colspan="2">
                                    La Pubblica Assistenza di Taverne vuole essere tua amica, vuole farti conoscere le sue attività, le sue iniziative e perchè no, coinvolgerti nei propri progetti.
                        Con il tuo assenzo ogni novità ti sarà comunicata e, se vuoi, potrai fornirci i tuoi suggerimenti, le tue considerazioni e quant'altro possa risultare utile per il miglioramento delle nostre iniziative.
                                <br />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    <asp:Button ID="btnIscrivi" runat="server" CssClass="Bottoni" 
                                        onclick="btnIscrivi_Click" Text="Iscriviti" />
                                </td>
                            </tr>
                            <tr>
                                <td align="justify" colspan="2">
                                    ...
                                    <br />
                                    <br />
                                    Dopo che avrai inserito i dati riceverai una e-mail all'indirizzo che ci hai indicato nella quale troverai un link
                                    per confermare la tua iscrizione al servizio di ricezione news.
                                    <br />
                                    <br />
                                    Per non ricevere più messaggi da noi ed essere eliminato dal servizio, inserisci 
                                    l&#39;indirizzo di posta su cui l&#39;hai attivato
                                    <asp:TextBox ID="txemail_disatt" runat="server" CssClass="TextBox" Width="40%"></asp:TextBox>
                                    &nbsp;e
                                    <asp:LinkButton ID="btnElimina" runat="server" onclick="btnElimina_Click">clicca qui</asp:LinkButton>
                                    , ricevereai una mail nella quale troverai un link per disattivare il servizio, 
                                    altrimenti contattaci all&#39;indirizzo pa.taverne@tin.it<br />
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="2">
                                    <asp:Label ID="lblErr1" runat="server" ForeColor="#990000" CssClass="TestoP"></asp:Label>
                                </td>
                            </tr>
                                    </table>
                                    </asp:Panel>
