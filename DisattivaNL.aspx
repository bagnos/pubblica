<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisattivaNL.aspx.cs" Inherits="pa_taverne.DisattivaNL" %>
            ...
            <tr>
                ...
                <td class="TdMainCorpo" align="center" valign="top">
                 <table cellpadding="3" class="TabellaGenerica" cellspacing="0" width="100%" >
                    <tr class="TrHeader">
                        <td align="center" class="TestoP"><b>DISATTIVA SERVIZIO "DIVENTA NOSTRO AMICO"</b></td>
                    </tr>
                    <tr>
                        <td align="center">
                            <br />
