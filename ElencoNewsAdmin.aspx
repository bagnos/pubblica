<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ElencoNewsAdmin.aspx.cs" Inherits="pa_taverne.ElencoNewsAdmin" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function Elimina(notizia) { 
        
            if(confirm("Vuoi Eliminare l'iniziativa?"))
            {
                location.href = 'ElencoNewsAdmin.aspx?act=E&notizia=' + notizia;
            }
        }
    </script>
    <style type="text/css">
            ...
            <tr>
                ...
                <td class="TdMainCorpo" align="center" valign="top">
                 <table cellpadding="3" class="TabellaGenerica" cellspacing="0" width="100%" >
                    <tr class="TrHeader">
                        <td align="center" class="TestoP"><b>AMMINISTRAZIONE SITO - ELENCO INIZIATIVE</b></td>
                    </tr>
                    <tr>
                        <td>
                        <br />
