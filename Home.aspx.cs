...
{
    public partial class Home : Pagebasic
    {
        ...
        public void ElencoNews()
        {
            ...
            try
            {
                ...
                if (dtNews.Rows.Count > 0)
                {
                    ...
                    lnblNews.Text = "<table cellpadding=\"4\" cellspacing=\"0\" border=\"0\" width=\"100%\">";
                    for (int i = 0; i < numnews; i++)
                    {
                        ...
                        lnblNews.Text = lnblNews.Text + "</tr>";
                        lnblNews.Text = lnblNews.Text + "<tr>";
                        lnblNews.Text = lnblNews.Text + "<td align=\"center\" style=\"width:100px\">";
                        if (Convert.ToInt32(dtNews.Rows[i]["DIFF"].ToString()) <= 10 && Convert.ToInt32(dtNews.Rows[i]["DIFF2"].ToString()) < 0)
                        {
                        ...
                        lnblNews.Text = lnblNews.Text + "</td>";
                        lnblNews.Text = lnblNews.Text + "<td class=\"TestoP\" valign=\"middle\" style=\"text-align:justify;\">";
