<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Album.aspx.cs" Inherits="pa_taverne.Album" %>
                ...
                <td class="TdMainCorpo" align="center" valign="top">
                 <table cellpadding="3" class="TabellaGenerica" cellspacing="0" width="100%" >
                    ...
                    <tr>
                        ...
                        &nbsp;
                            <br />
                            <asp:Label ID="lblAlbum" runat="server" CssClass="TestoM" Font-Bold="True"></asp:Label>
                            <br />
                            <br />
                            <asp:Label ID="lblFoto" runat="server" CssClass="TestoP"></asp:Label>
                            <br />
                            <br />
