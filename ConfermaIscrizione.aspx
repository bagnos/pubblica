<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfermaIscrizione.aspx.cs" Inherits="pa_taverne.ConfermaIscrizione" %>
            ...
            <tr>
                ...
                <td class="TdMainCorpo" align="center" valign="top">
                 <table cellpadding="3" class="TabellaGenerica" cellspacing="0" width="100%" >
                    <tr class="TrHeader">
                        <td align="center" class="TestoP"><b>CONFERMA ISCRIZIONE</b></td>
                    </tr>
                    <tr>
                        <td align="center">
                            <br />
