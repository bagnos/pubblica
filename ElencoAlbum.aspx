<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ElencoAlbum.aspx.cs" Inherits="pa_taverne.ElencoAlbum" %>
            ...
            <tr>
                ...
                <td class="TdMainCorpo" align="center" valign="top">
                 <table cellpadding="3" class="TabellaGenerica" cellspacing="0" width="100%"  >
                    <tr class="TrHeader">
                        <td align="center" class="TestoP"><b>ARCHIVIO FOTOGRAFICO</b></td>
                    </tr>
                    <tr>
                        <td align="center" >
                            &nbsp;
                            <br />
                            <asp:Label ID="lblTipoAlbum" runat="server" CssClass="TestoM" Font-Bold="True"></asp:Label>
                            <br />
                            <br />
                            <asp:Label ID="lblAlmum" runat="server" CssClass="TestoP"></asp:Label>
                            <br />
                            <br />
