<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="ModificaNotizia.aspx.cs" Inherits="pa_taverne.ModificaNotizia" %>
            ...
            <tr>
                ...
                <td class="TdMainCorpo" align="center" valign="top">
                 <table cellpadding="3" class="TabellaGenerica" cellspacing="0" width="100%" >
                    <tr class="TrHeader">
                        <td align="center" class="TestoP"><b>MODIFICA INIZIATIVA</b></td>
                    </tr>
                    <tr>
                        <td class="TestoM" align="center" >
                            <br />
                            <b>MODIFICA INIZIATIVA</b>
                            <br />
                            <br />
                        ...
                        <table cellpadding="3" cellspacing="0" width="90%">
                            ...
                            <tr>
                                ...
                                &nbsp;<asp:Button ID="btnAnnulla" runat="server" CssClass="Bottoni" 
                                        Text="Annulla" onclick="btnAnnulla_Click" />
                                </td>
                            </tr>
                        </table>
                            <br />
